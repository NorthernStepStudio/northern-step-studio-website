...
export default function Services() {
  ...
  const useCases = [
    ...
    { title: "Business systems", icon: Zap },
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="pt-2">
              <Link to="/contact?intent=start-project" className="btn-pill-primary">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <motion.div variants={itemVariants} className="space-y-6">
                ...
                <div className="pt-6 flex flex-wrap gap-3">
                  <Link to="/contact?intent=start-project" className="btn-pill-primary text-xs py-2.5 px-6">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="flex justify-center">
               <Link to="/contact?intent=start-project" className="btn-pill-primary px-8">
                 {t("services.cta.quote")}
               </Link>
            </motion.div>
          </motion.div>
