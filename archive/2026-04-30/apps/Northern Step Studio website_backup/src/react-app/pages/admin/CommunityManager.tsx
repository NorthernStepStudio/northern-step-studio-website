...
export default function CommunityManager() {
  ...
  const loadThreads = () => {
    apiFetch("/api/community/threads")
      ...
      .catch((err) => {
        ...
        setThreads([]);
        setErrorMessage(err instanceof Error ? err.message : "Failed to load threads");
        setLoading(false);
      });
  };
  ...
  const togglePin = async (id: number, currentState: boolean) => {
    try {
      ...
      setErrorMessage(err instanceof Error ? err.message : "Failed to update thread");
    }
  };
  ...
  const deleteThread = async (id: number) => {
    ...
    try {
      ...
      setErrorMessage(err instanceof Error ? err.message : "Failed to delete thread");
    }
  };
