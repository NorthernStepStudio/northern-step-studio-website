...
import { AlertCircle, BookOpen, CheckCircle, Mail, MessageCircle, PhoneCall, Send } from "lucide-react";
...
export default function Contact() {
  ...
  useEffect(() => {
    ...
    applyPreset(intent, tier, industry);
  }, [intent, tier, industry]);
            ...
            <div className="flex flex-wrap gap-2">
              {requestPresets.map((preset) => (
                <button
                  key={preset.key}
                  type="button"
                  onClick={() => applyPreset(preset.key, tier, industry)}
