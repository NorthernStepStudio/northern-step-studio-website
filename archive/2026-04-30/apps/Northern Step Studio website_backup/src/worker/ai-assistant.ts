...
import { routeMessage } from "../../packages/synox/response-router.ts";
import { runStudioGraph, type StudioRuntimeOptions } from "../../packages/synox/graph/index.ts";
...
export async function handleAIRequest(input: AgentInput, runtime: StudioRuntimeOptions = {}): Promise<AgentOutput> {
  return runStudioGraph(input, runtime);
}
