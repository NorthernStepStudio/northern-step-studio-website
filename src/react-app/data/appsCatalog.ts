...
export const CATALOG_APPS: CatalogApp[] = [
  ...
  },
  {
    ...
    statusLabel: "Beta",
    targetDate: "Q3 2026",
    techStack: ["React Native", "Habit Tracking", "Progress Logging"],
    progress: [
  ...
  },
  {
    ...
    logo: BRAND_ASSETS.noobsInvesting,
    screenshots: [],
