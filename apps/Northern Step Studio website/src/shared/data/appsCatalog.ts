...
export const CATALOG_APPS: CatalogApp[] = [
  ...
  },
  {
    ...
    name: "Neuromove",
    slug: "neuromoves",
    tagline: "Guided Learning Companion for Children",
    description:
      "A guided learning companion for young children, with structured routines, parent tools, and progress tracking.",
    fullDescription:
      "Neuromove is designed around structured movement, communication, and routine-building activities for children. It combines approachable visuals, guided prompts, parent-facing tools, and progress reporting to keep the app useful outside of a single session.",
    category: "LEARNING",
    status: "BETA",
    statusLabel: "Beta",
    targetDate: "Q3 2026",
    techStack: ["React Native", "Learning Activities", "Parent Profiles"],
    progress: [
      { text: "Core learning activity flows, auth, and onboarding", completed: true },
      ...
      { text: "Learning content QA and launch cleanup", completed: false },
    ],
