...
export const CATALOG_APPS: CatalogApp[] = [
  ...
  },
  {
    ...
    description: "Scan, transcribe, edit, and export your paper notes from any mobile browser.",
    fullDescription: "ScanScribe is a simple web app that turns handwritten paper notes into clean digital documents. Upload or scan a page, review the extracted text, clean it up, and save or share it as a polished document.",
    category: "PRODUCTIVITY",
    status: "LIVE",
    statusLabel: "Live",
    targetDate: null,
    techStack: ["React", "Vite", "Node.js API", "IndexedDB"],
    progress: [
      { text: "Core OCR pipeline and scanning", completed: true },
    ...
    video_url: null,
    features: [
      "Scan or upload handwritten notes",
      "Convert handwriting into editable text",
      "Clean and format rough notes",
      "Save, copy, share, or export documents",
  ...
  },
  {
    ...
    name: "SignaTempu",
    slug: "signatempu",
    tagline: "Field worker time tracking and clock-in system",
    description: "Easy time tracking for field workers with GPS verification, project management, and reporting.",
    fullDescription: "SignaTempu is a field-worker time tracking and clock-in system designed for teams. Track hours with GPS location capture, organize projects, invite workers, and generate payroll-ready reports.",
    category: "PRODUCTIVITY",
    status: "LIVE",
    statusLabel: "Live",
    targetDate: null,
    techStack: ["React", "Vite", "Node.js API", "Supabase"],
    progress: [
      { text: "Time tracking and clock-in engine", completed: true },
      { text: "GPS location capture and validation", completed: true },
      { text: "Project and team management", completed: true },
      { text: "Payroll report generation", completed: true },
    ],
    ...
    video_url: null,
    features: [
      "Clock-in and out with real-time tracking",
      "GPS location capture for site verification",
      "Project and sub-task allocation",
      "Generate and send payroll reports",
