...
export const ProgressManager = {
    ...
    async syncWithBackend(moduleId, level) {
        ...
        try {
            await fetch(`${Config.apiBase}/users/${this.userId}/progress`, {
                method: 'POST',
    ...
    async loadFromBackend() {
        ...
        try {
            const res = await fetch(`${Config.apiBase}/users/${this.userId}/progress`);
    ...
    updateProgressBars() {
        const moduleMap = {
            ...
            'bodyparts': 'bodyparts', 'animals': 'animals', 'sizes': 'sizes'
        };
