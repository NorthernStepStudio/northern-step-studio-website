...
function PointItOutGameInner({ onRestartGame, onResetLevel }: InnerProps) {
    ...
    const toggleSpeech = useCallback(async () => {
        if (!speechAvailable) {
            showFeedback({
                type: 'hint',
                message: t('pointItOut.voiceUnavailable', { defaultValue: 'Voice input is unavailable on this build.' }),
            }, 1200);
            return;
        }
    ...
    }, [isListening, currentTarget, handleObjectFound, showFeedback, speechAvailable, t]);
        ...
        <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
            ...
            <View style={styles.debugActions}>
                <Pressable
                    ...
                    style={[
                        styles.voiceButton,
                        !speechAvailable && styles.voiceButtonDisabled,
