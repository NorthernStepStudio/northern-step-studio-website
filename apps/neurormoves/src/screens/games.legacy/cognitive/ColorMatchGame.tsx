...
export default function ColorMatchGame() {
    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            speak(t('colorMatch.instruction', { color: t(`colorMatch.voiceLabels.${target.name}`) }), { shouldLock: true });
        }, 100);
    ...
    const handleColorPress = useCallback(async (color: ColorOption) => {
        ...
        if (color.name === targetColor.name) {
            ...
            speak(t('colorMatch.successMessage'), { shouldLock: true });
        ...
        <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
            ...
            <View style={styles.gameArea}>
                ...
                <GameInstruction
                    ...
                    subtext={`${t('colorMatch.level')} ${gameState.level} • ${getOptionsCount()} ${t('colorMatch.colors_plural')}`}
                />
