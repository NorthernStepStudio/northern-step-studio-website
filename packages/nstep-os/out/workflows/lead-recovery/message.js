...
export function buildLeadRecoveryMessage(input, assessment, scenario = "generic-callback") {
    ...
    const urgencyLine = assessment.urgency === "emergency"
...
export function validateLeadRecoveryDraft(draft, decision) {
