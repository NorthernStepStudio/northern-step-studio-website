...
export function buildNexusBuildRecommendation(intake, compatibility, analysis, comparison, pricingSnapshots = []) {
...
function buildAlternateParts(intake, compatibility, analysis) {
    const suggestions = [];
...
function buildUpgradePath(intake, compatibility, analysis, comparison) {
    const path = [];
...
function buildBudgetOptimizations(intake, compatibility, analysis) {
    const optimizations = [];
...
function resolvePurchaseStrategy(intake, compatibility, analysis, comparison, pricingSnapshots) {
    if (compatibility.status === "fail") {
...
function buildPremiumGuidance(intake, compatibility, analysis, comparison, purchaseStrategy) {
    const guidance = [
