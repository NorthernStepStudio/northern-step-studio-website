...
export function buildNexusBuildAnalysisReport(context) {
...
export function buildNexusBuildWorkflowResult(context, report) {
...
export function buildNexusBuildActions(context) {
    const actions = [
...
function buildSummary(context) {
    const compatibilityLine = context.compatibility.status === "pass"
    ...
    const pricingLine = context.pricingSnapshots.length > 0
