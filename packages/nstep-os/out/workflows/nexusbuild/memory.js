...
export function buildNexusBuildMemoryEntries(intake, report) {
    ...
    const entries = [
        {
            ...
            lesson: createMemoryLesson(report.compatibility.status === "pass"
                ? {
                    outcome: "success",
...
function extractPreferenceValue(intake, report) {
