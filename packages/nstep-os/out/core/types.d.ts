...
export type JobStatus = "pending" | "queued" | "routing" | "planning" | "waiting_approval" | "running" | "verifying" | "failed" | "completed";
...
export type LeadRecoveryScenario = "generic-callback" | "after-hours" | "service-inquiry" | "quote-followup" | "appointment-callback";
...
export type ProvLyWorkflowType = "inventory-intake" | "documentation-review" | "claim-preparation" | "room-review" | "reminder-generation" | "export-generation" | "high-value-review";
export type ProvLyItemCategory = "furniture" | "electronics" | "appliance" | "jewelry" | "art" | "clothing" | "tools" | "kitchenware" | "sports" | "media" | "documents" | "collectibles" | "decor" | "other";
...
export type NexusBuildWorkflowType = "build-intake" | "compatibility-review" | "bottleneck-analysis" | "price-monitoring" | "recommendation-report" | "parts-comparison";
export type NexusBuildUseCase = "gaming" | "productivity" | "creator" | "budget" | "workstation" | "general";
export type NexusBuildComponentCategory = "cpu" | "motherboard" | "gpu" | "memory" | "storage" | "psu" | "case" | "cooler" | "monitor" | "accessory";
...
export type MemoryCategory = "workflow-template" | "success-pattern" | "failure-pattern" | "user-preference" | "business-rule" | "communication-tone" | "tenant-constraint";
...
export interface VerificationFinding {
    ...
    readonly category: "acceptance" | "allowed_files" | "forbidden_files" | "build" | "test" | "blocker" | "scope_expansion" | "deliverables" | "workspace" | "payload" | "delivery" | "compliance";
    readonly message: string;
