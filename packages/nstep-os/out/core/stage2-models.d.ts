import type { ApprovalStatus, GoalInput, GoalMode, JobRecord, JobStepState, DashboardSnapshot, MemoryEntry, NStepLogger, PrincipalRole, ProductKey, RouteDecision, RiskLevel, RuntimeConfig, RuntimeStores, StepResult, VerificationResult, WorkflowDefinition, WorkflowExecutionContext, WorkflowPlan, WorkflowPlanningContext, WorkflowResult, WorkflowKey } from "./types.js";
export type Stage2AgentId = "supervisor-agent" | "thinker-agent" | "router-agent" | "source-gatherer-agent" | "planner-agent" | "research-agent" | "execution-agent" | "communication-agent" | "verification-agent" | "memory-agent" | "reporting-agent";
export type Stage2AgentCapability = "review" | "reason" | "classify" | "gather" | "plan" | "research" | "execute" | "compose" | "verify" | "remember" | "report";
export type Stage2PermissionScope = "supervision" | "goal" | "thinking" | "route" | "sources" | "plan" | "job" | "step" | "research" | "message" | "memory" | "report" | "dashboard";
...
export declare function defineStage2Permission(scope: Stage2PermissionScope, capabilities: readonly Stage2AgentCapability[], description: string, options?: {
    readonly mayUseExternalTools?: boolean;
    readonly requiresApprovalForExternalActions?: boolean;
}): Stage2AgentPermission;
export declare function defineStage2Responsibility(title: string, summary: string, stage1Touchpoints: readonly string[]): Stage2AgentResponsibility;
...
export type Stage2RuntimePhase = "supervision" | "thinking" | "routing" | "source-gathering" | "planning" | "research" | "execution" | "communication" | "verification" | "memory" | "reporting";
