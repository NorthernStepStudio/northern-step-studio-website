...
export type Stage3ToolProvider = "mock" | "playwright" | "twilio" | "webhook" | "file" | "postgres" | "supabase" | "memory" | "redis" | "generic-http";
...
export declare function defineStage3Permission(tool: ToolName, actions: readonly string[], description: string, options?: {
    readonly allowExternalActions?: boolean;
    readonly requiresApprovalForExternalActions?: boolean;
    readonly permittedAgents?: readonly Stage2AgentId[];
}): Stage3ToolPermission;
export declare function defineStage3Descriptor(tool: ToolName, provider: Stage3ToolProvider, actions: readonly string[], permission: Stage3ToolPermission, options?: {
    readonly canRetry?: boolean;
    readonly scoped?: boolean;
