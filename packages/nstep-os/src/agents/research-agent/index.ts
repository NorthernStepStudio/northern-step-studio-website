import {
  ...
  type Stage2Bridge,
  type Stage2ResearchRequest,
  type Stage2ResearchResult,
} from "../../core/stage2-models.js";

const researchResponsibilities = [
  defineStage2Responsibility(
    "Source digestion",
    "Collects and structures source references for later research and monitoring workflows.",
    ["research"],
  ),
  defineStage2Responsibility(
    "Evidence summary",
    "Produces a compact evidence summary that can be audited by the runtime or admin views.",
    ["research", "reporting"],
  ),
  defineStage2Responsibility(
    "Research readiness",
    "Keeps the interface generic so the runtime can swap in browser, API, or local providers later.",
...
const researchPermissions = [
  defineStage2Permission(
    "research",
    ["research"],
    "May prepare and structure research requests and source lists.",
    {
...
export function createResearchAgent(context: Stage2AgentFactoryContext, _bridge: Stage2Bridge): ResearchAgent {
