...
import type { MemoryEntry, ProvLyAnalysisReport, ProvLyIntake } from "../../core/types.js";
import { createMemoryLesson } from "../../memory/index.js";

export function buildProvLyMemoryEntries(intake: ProvLyIntake, report: ProvLyAnalysisReport): MemoryEntry[] {
  ...
  const entries: MemoryEntry[] = [
    {
      ...
      lesson: createMemoryLesson(
        report.completeness.claimReady
          ? {
              outcome: "success",
